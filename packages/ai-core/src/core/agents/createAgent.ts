...
import { createExecutor } from '../runtime/createExecutor';
...
export async function createAgent<
  ...
  TOOLS extends ToolSet = {},
>(
  options: CreateAgentOptions<TSettingsMap, T, TOOLS>,
): Promise<ToolLoopAgent<never, TOOLS, never>> {
  ...
  executor.pluginEngine.usePlugins([
    executor.createResolveModelPlugin(),
    executor.createConfigureContextPlugin(),
  ]);
