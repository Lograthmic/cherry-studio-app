...
export function readProviderRegistry(jsonPath: string): {
  version: string;
...
export function readProviderModelRegistry(jsonPath: string): {
  version: string;
...
export class RegistryLoader {
  ...
  loadModels(): ModelConfig[] {
    ...
    this.buildModelIndex(this.models);
    return this.models;
  }
  ...
  /** Load and cache providerModels.json. Returns overrides array. */
  loadProviderModels(): ProviderModelOverride[] {
    ...
    this.buildOverrideIndex(this.providerModels);
  ...
  private buildOverrideIndex(providerModels: ProviderModelOverride[]): void {
