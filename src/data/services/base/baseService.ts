 ...
 */
export interface ISoftDeleteService<T = any, TCreate = any, TUpdate = any>
  extends IBaseService<T, TCreate, TUpdate> {
  /**
   * Archive entity (soft delete)
   */
  // biome-ignore lint/suspicious/noConfusingVoidType: Cherry shared service contract uses T | void.
 ...
 */
export interface ISearchableService<T = any, TCreate = any, TUpdate = any>
  extends IBaseService<T, TCreate, TUpdate> {
  /**
 ...
 */
export interface IHierarchicalService<TParent = any, TChild = any, TChildCreate = any>
  extends IBaseService<TParent> {
  /**
